...
addOptional(parser,'normalize',true)
addOptional(parser,'perturb',false) % wether to use perturbation (default = false)
addOptional(parser,'alpha',0.1) % perturbation parameter (default = 0.1)
addOptional(parser,'pert_geom',true) % geometric versus arithmatic scaling (default = geometric)
addOptional(parser,'idx',1:K) % indices of eigenvector to keep for low-d representation. (default=1:K)
